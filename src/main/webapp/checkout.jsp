					...
					<div class="card-body">
						...
						<form action="order" method="post">
							...
							<div class="form-row">
								<div class="form-group col-md-6">
									<label for="inputEmail4">Name</label><input type="text" name="username"
										class="form-control" id="inputEmail4" value="${userobj.name}" readonly="readonly" required>
								</div>
								<div class="form-group col-md-6">
									<label for="inputEmail4">Email</label><input type="email"  name="email"
										class="form-control" id="inputEmail4" value="${userobj.email}" readonly="readonly" required>
								</div>
							</div>
							...
							<div class="form-row">
								...
								<div class="form-group col-md-6">
									<label for="inputEmail4">Address</label><input type="text" name="address"
							...
							<div class="form-row">
								...
								<div class="form-group col-md-6">
									<label for="inputEmail4">Pin Code</label><input type="number"  name="pincode"
										class="form-control" id="inputEmail4" value="" required>
								</div>
							</div>
