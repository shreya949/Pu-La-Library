...
<div class="container-fluid p-3 bg-light">
    <div class="row">
        <div class="col-md-3 text-success">
            <h3><i class="fa-solid fa-book"></i> PuLa Library</h3>
        </div>
        <div class="col-md-6">
            ...
            <c:when test="${not empty userobj}">
                <div class="col-md-3">
                    ...
                    <a href="login.jsp" class="btn btn-success">
                        <i class="fa-solid fa-user-plus"></i> ${userobj.name}
                    </a>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav mr-auto">
            ...
            <li class="nav-item active"><a class="nav-link" href="./all_recent_book.jsp">
                <i class="fa-solid fa-book-open"></i> Recent Book</a></li>
            ...
            <li class="nav-item active"><a class="nav-link disabled" href="./all_old_book.jsp">
                <i class="fa-solid fa-book-open"></i> Old Book</a></li>
        </ul>
